...
// Charger le handler UNE FOIS au démarrage
let handler;
try {
    handler = require('./handler');
    console.log(chalk.green('✅ Handler chargé avec succès'));
} catch (error) {
    console.error(chalk.red('❌ Erreur lors du chargement du handler:'), error);
}
